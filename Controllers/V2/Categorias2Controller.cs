...
namespace Controllers
{
    ...
    public class Categorias2Controller : ControllerBase
    {
        ...
        public Categorias2Controller(IGenericRepository<Categoria> _genericRepository, DataContext _context, IConfigurationHelper configHelper)
        {
